...
class SmartAccessAiGenerator:
    ...
    def _workflow_payload(self, prompt: str, context: dict[str, Any]) -> dict[str, Any]:
        ...
        system = (
            ...
            "Allowed actions: click, double_click, type, hotkey, press_enter, ocr, wait.\n"
            ...
            "no delay.\n"
            "Never place OCR match fields on click, double_click, type, hotkey, press_enter, or wait steps. "
