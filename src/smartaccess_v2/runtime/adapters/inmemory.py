...
(``UdpProcessExecutorClient`` and the real parser) in :mod:`smartaccess_v2.bootstrap`.
"""
...
from smartaccess_v2.runtime.application.ports import GenerationResult, ProcessExecutionState
